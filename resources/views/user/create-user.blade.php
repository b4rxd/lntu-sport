...
<div class="d-flex justify-content-center align-items-start mt-4">
    <div class="card shadow-lg p-4 text-left" style="max-width: 800px; width: 100%;">
        ...
        <form action="{{ route('user.storeUser') }}" method="POST">
            ...
            <div class="mb-3">
                <label class="form-label d-block">Продукти:</label>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="permissions[]" value="view_product" id="view_product">
                    <label class="form-check-label" for="view_product">Перегляд продуктів</label>
                </div>
                <div class="form-check">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="permissions[]" value="activate_product" id="activate_product">
                    <label class="form-check-label" for="activate_product">Активація продуктів</label>
                </div>
            </div>

            <div class="mb-3">
                <label class="form-label d-block">Локації:</label>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="permissions[]" value="view_location" id="view_location">
                    <label class="form-check-label" for="view_location">Перегляд локацій</label>
                </div>
                <div class="form-check">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="permissions[]" value="activate_location" id="activate_location">
                    <label class="form-check-label" for="activate_location">Активація локацій</label>
                </div>
            </div>
            ...
            <div class="mb-3">
                <label class="form-label d-block">Повернення:</label>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="permissions[]" value="view_return" id="view_return">
                    <label class="form-check-label" for="view_return">Перегляд повернень</label>
                </div>
                <div class="form-check">
